...
- **Trajectory data-plane evidence before migration**: the [Lane D D1 plan](docs/internal/plans/lane_d_data_convergence.md) now maps every current runtime/trace/tracing/render/qita/checkpoint and distribution path, records public-surface removal blockers, selects two privacy-gated fixture sources, and provides a typed benchmark-readiness preflight. It does not change trace v1 or qita, publish sensitive fixtures, claim compression gains, or freeze trajectory v2.
