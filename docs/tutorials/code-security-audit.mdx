...
If you open [`examples/real/whitzard_agent.py`](https://github.com/WhitzardAgent/WhitzardOS/blob/main/examples/real/whitzard_agent.py), you can see the next design idea in the course:
...
- [`examples/real/code_security_audit_agent.py`](https://github.com/WhitzardAgent/WhitzardOS/blob/main/examples/real/code_security_audit_agent.py)
- [`examples/real/whitzard_agent.py`](https://github.com/WhitzardAgent/WhitzardOS/blob/main/examples/real/whitzard_agent.py)
