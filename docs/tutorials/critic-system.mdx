...
<CardGroup>
  <Card title="Hooks Lifecycle" href="/tutorials/hook-lifecycle">
    Understand the full Engine event lifecycle that critics participate in.
  </Card>
  <Card title="Agent Module" href="/concepts/agent-module">
    Deep dive into the AgentModule interface that critics inspect.
  </Card>
  <Card title="Critics and Stop Criteria" href="/guides/critics-and-stop-criteria">
