# `qitos.kit.parser.xml_parser`

- Module Group: `qitos.kit`
- Source: [qitos/kit/parser/xml_parser.py](https://github.com/Qitor/qitos/blob/main/qitos/kit/parser/xml_parser.py)

## Quick Jump

- [Classes](#classes)
- [Functions](#functions)
- [Class: `XmlDecisionParser`](#class-xmldecisionparser)
