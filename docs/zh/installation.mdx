...
<Note>本教程使用已包含 Python 3.10 publication 修复的 60809b3。历史 G5 baseline 为 717b4cf1b23f2ed252cd03234ffd8605038d9567；上面的历史 wheel digest 仅属于该历史资格。本轮不会把历史测试归属到新源码。</Note>
