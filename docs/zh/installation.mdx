...
<Warning>远端 CI 发现 Python 3.10 的 publication 调用了不存在的 hashlib.file_digest。此路径请使用 Python 3.11+；历史本地 G5 资格具体覆盖 3.12.7。Python 3.10 CI 保留失败，等待另行授权的运行时修复。</Warning>
