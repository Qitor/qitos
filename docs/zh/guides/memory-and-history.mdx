...
本教程使用下方固定的 R1 融合实现；源码安装不代表已发布 PyPI 版本。
...
[Source file](https://github.com/WhitzardAgent/WhitzardOS/blob/f7d4b2d666a156d361da496a41868278f84ffabf/examples/tutorials/notes/context.py) (可选；全部所需代码已在本页)
