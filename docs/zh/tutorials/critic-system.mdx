...
<CardGroup>
  <Card title="Hooks 生命周期" href="/zh/tutorials/hook-lifecycle">
    了解 Critic 参与的完整 Engine 事件生命周期。
  </Card>
  <Card title="Agent Module" href="/zh/concepts/agent-module">
    深入了解 Critic 审查的 AgentModule 接口。
  </Card>
  <Card title="Critic 与停止条件" href="/zh/guides/critics-and-stop-criteria">
