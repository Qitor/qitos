...
documentation task. Runtime identity remains
`717b4cf1b23f2ed252cd03234ffd8605038d9567`.
Dispatch identity: the final remote-verified documentation SHA, recorded in the
promotion ledger. **Do not dispatch until that identity exists and local,
