...
Place the locally built Lane D wheel (runtime source `df93164`) beside this lesson before installing. This lane has not been published. The deterministic installed example is `examples/v5/r1_d_trajectory/consumer.py`.
