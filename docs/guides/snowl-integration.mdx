...
<Warning>Historical adapter design / 历史适配器设计。ToolMeta examples are not G5 APIs. Use the third-party extension guide for current contracts; this page is not executable qualification.</Warning>
