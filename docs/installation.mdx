...
| GitHub development branch | `python -m pip install "qitos @ git+https://github.com/Qitor/qitos.git@feat/campaign-absorption"` | Moving development tree; record the resolved SHA |
...
python -m pip install "qitos @ git+https://github.com/Qitor/qitos.git@717b4cf1b23f2ed252cd03234ffd8605038d9567"
...
`qitos[openai] @ git+https://github.com/Qitor/qitos.git@717b4cf1b23f2ed252cd03234ffd8605038d9567`.
