...
| `qitos.tracing` | canonical Trajectory contracts/store/readers plus diagnostic span processors | `create_trace`, `add_trace_processor`, `TracingProvider`, `EventSink` | core (canonical `ArtifactRef`) | engine, kit, models, benchmark, recipes at module level |
