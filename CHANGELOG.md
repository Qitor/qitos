...
- Requalified Lane D against immutable A/B/C source heads and the exact replayed or repaired producer bytes actually executed. The candidate Trajectory plane remains unfrozen and off, qita's default remains frozen trace-v1, and live-model qualification is `blocked_configuration`; therefore no baseline promotion, push, release claim, or worktree cleanup is authorized.
