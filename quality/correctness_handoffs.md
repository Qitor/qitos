...
- `qitos/kit/tool/delegate.py:147:17` — `mypy:attr-defined` / `impossible-import`: Module "qitos.models.profile_registry" has no attribute "resolve_model"
- `qitos/kit/tool/fanout.py:88:28` — `mypy:operator` / `explicit-runtime-error`: Unsupported operand types for + ("float" and "None")
