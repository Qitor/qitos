...
from qitos.core.skill import skill, Skill
...
class EditorSkill(Skill):
    """
    File editor skill providing comprehensive file manipulation capabilities.
    ...
    @skill(name='create', domain='editor')
    ...
    @skill(name='insert', domain='editor')
    ...
    @skill(name='search', domain='editor')
    ...
    @skill(name='list_tree', domain='editor')
    ...
    @skill(name='replace_lines', domain='editor')
